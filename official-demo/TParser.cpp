...
void TParser::ExprContext::copyFrom(ExprContext *ctx) {
  ...
  this->type = ctx->type;
  this->rnIndex = ctx->rnIndex;
}

//----------------- QuestionExpressionContext ------------------------------------------------------------------

std::vector<TParser::ExprContext *> TParser::QuestionExpressionContext::expr() {
  return getRuleContexts<TParser::ExprContext>();
}

TParser::ExprContext* TParser::QuestionExpressionContext::expr(size_t i) {
  return getRuleContext<TParser::ExprContext>(i);
}

tree::TerminalNode* TParser::QuestionExpressionContext::QuestionMark() {
  return getToken(TParser::QuestionMark, 0);
}

tree::TerminalNode* TParser::QuestionExpressionContext::Colon() {
  return getToken(TParser::Colon, 0);
}

TParser::QuestionExpressionContext::QuestionExpressionContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::QuestionExpressionContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterQuestionExpression(this);
}
void TParser::QuestionExpressionContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitQuestionExpression(this);
}

antlrcpp::Any TParser::QuestionExpressionContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
    return parserVisitor->visitQuestionExpression(this);
  else
    return visitor->visitChildren(this);
}
//----------------- StringLiteralExpressionContext ------------------------------------------------------------------

tree::TerminalNode* TParser::StringLiteralExpressionContext::String() {
  return getToken(TParser::String, 0);
}

TParser::StringLiteralExpressionContext::StringLiteralExpressionContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::StringLiteralExpressionContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterStringLiteralExpression(this);
}
void TParser::StringLiteralExpressionContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitStringLiteralExpression(this);
}

antlrcpp::Any TParser::StringLiteralExpressionContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
...
std::vector<TParser::ExprContext *> TParser::StarExpressionContext::expr() {
  return getRuleContexts<TParser::ExprContext>();
}

TParser::ExprContext* TParser::StarExpressionContext::expr(size_t i) {
  return getRuleContext<TParser::ExprContext>(i);
}

tree::TerminalNode* TParser::StarExpressionContext::Star() {
  return getToken(TParser::Star, 0);
}

TParser::StarExpressionContext::StarExpressionContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::StarExpressionContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterStarExpression(this);
}
void TParser::StarExpressionContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitStarExpression(this);
}

antlrcpp::Any TParser::StarExpressionContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
    return parserVisitor->visitStarExpression(this);
  else
    return visitor->visitChildren(this);
}
//----------------- EquealExpressoinContext ------------------------------------------------------------------

std::vector<TParser::ExprContext *> TParser::EquealExpressoinContext::expr() {
  return getRuleContexts<TParser::ExprContext>();
}

TParser::ExprContext* TParser::EquealExpressoinContext::expr(size_t i) {
  return getRuleContext<TParser::ExprContext>(i);
}

tree::TerminalNode* TParser::EquealExpressoinContext::Equal() {
  return getToken(TParser::Equal, 0);
}

TParser::EquealExpressoinContext::EquealExpressoinContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::EquealExpressoinContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterEquealExpressoin(this);
}
void TParser::EquealExpressoinContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitEquealExpressoin(this);
}

antlrcpp::Any TParser::EquealExpressoinContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
    return parserVisitor->visitEquealExpressoin(this);
  else
    return visitor->visitChildren(this);
}
//----------------- FlowControlExpressionContext ------------------------------------------------------------------

TParser::FlowControlContext* TParser::FlowControlExpressionContext::flowControl() {
  return getRuleContext<TParser::FlowControlContext>(0);
}

TParser::FlowControlExpressionContext::FlowControlExpressionContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::FlowControlExpressionContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterFlowControlExpression(this);
}
void TParser::FlowControlExpressionContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitFlowControlExpression(this);
}

antlrcpp::Any TParser::FlowControlExpressionContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
    return parserVisitor->visitFlowControlExpression(this);
  else
    return visitor->visitChildren(this);
}
//----------------- IntLteralExpressoinContext ------------------------------------------------------------------

tree::TerminalNode* TParser::IntLteralExpressoinContext::INT() {
  return getToken(TParser::INT, 0);
}

TParser::IntLteralExpressoinContext::IntLteralExpressoinContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::IntLteralExpressoinContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterIntLteralExpressoin(this);
}
void TParser::IntLteralExpressoinContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitIntLteralExpressoin(this);
}

antlrcpp::Any TParser::IntLteralExpressoinContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
    return parserVisitor->visitIntLteralExpressoin(this);
  else
    return visitor->visitChildren(this);
}
//----------------- PLusExpressionContext ------------------------------------------------------------------

std::vector<TParser::ExprContext *> TParser::PLusExpressionContext::expr() {
  return getRuleContexts<TParser::ExprContext>();
}

TParser::ExprContext* TParser::PLusExpressionContext::expr(size_t i) {
  return getRuleContext<TParser::ExprContext>(i);
}

tree::TerminalNode* TParser::PLusExpressionContext::Plus() {
  return getToken(TParser::Plus, 0);
}

TParser::PLusExpressionContext::PLusExpressionContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::PLusExpressionContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterPLusExpression(this);
}
void TParser::PLusExpressionContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitPLusExpression(this);
}

antlrcpp::Any TParser::PLusExpressionContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
...
tree::TerminalNode* TParser::ParExpressionContext::OpenPar() {
  return getToken(TParser::OpenPar, 0);
}

TParser::ExprContext* TParser::ParExpressionContext::expr() {
  return getRuleContext<TParser::ExprContext>(0);
}

tree::TerminalNode* TParser::ParExpressionContext::ClosePar() {
  return getToken(TParser::ClosePar, 0);
}

TParser::ParExpressionContext::ParExpressionContext(ExprContext *ctx) { copyFrom(ctx); }
...
TParser::IdContext* TParser::IdentifierExpressionContext::id() {
  return getRuleContext<TParser::IdContext>(0);
}

TParser::IdentifierExpressionContext::IdentifierExpressionContext(ExprContext *ctx) { copyFrom(ctx); }

void TParser::IdentifierExpressionContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterIdentifierExpression(this);
}
void TParser::IdentifierExpressionContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<TParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitIdentifierExpression(this);
}

antlrcpp::Any TParser::IdentifierExpressionContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<TParserVisitor*>(visitor))
  ...
  try {
    ...
    switch (_input->LA(1)) {
      case TParser::OpenPar: {
        _localctx = _tracker.createInstance<ParExpressionContext>(_localctx);
        _ctx = _localctx;
      ...
      case TParser::ID: {
        ...
        previousContext = _localctx;
        setState(94);
        dynamic_cast<IdentifierExpressionContext *>(_localctx)->identifier = id();
        break;
      }

      case TParser::Return:
      case TParser::Continue: {
        _localctx = _tracker.createInstance<FlowControlExpressionContext>(_localctx);
        _ctx = _localctx;
        previousContext = _localctx;
        setState(95);
        flowControl();
      ...
      case TParser::INT: {
        _localctx = _tracker.createInstance<IntLteralExpressoinContext>(_localctx);
        _ctx = _localctx;
        previousContext = _localctx;
        setState(96);
        dynamic_cast<IntLteralExpressoinContext *>(_localctx)->lteral = match(TParser::INT);
        break;
      }
      ...
      case TParser::String: {
        ...
        setState(98);
        dynamic_cast<StringLiteralExpressionContext *>(_localctx)->lteral = match(TParser::String);
        break;
      }
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        case 1: {
          auto newContext = _tracker.createInstance<StarExpressionContext>(_tracker.createInstance<ExprContext>(parentContext, parentState));
          ...
          setState(103);
          expr(10);
           dynamic_cast<StarExpressionContext *>(_localctx)->type =  "StarExpression"; 
          break;
        }

        case 2: {
          auto newContext = _tracker.createInstance<PLusExpressionContext>(_tracker.createInstance<ExprContext>(parentContext, parentState));
          _localctx = newContext;
          ...
          setState(107);
          dynamic_cast<PLusExpressionContext *>(_localctx)->op = match(TParser::Plus);
          setState(108);
          dynamic_cast<PLusExpressionContext *>(_localctx)->rhs = expr(9);
          break;
        }

        case 3: {
          auto newContext = _tracker.createInstance<QuestionExpressionContext>(_tracker.createInstance<ExprContext>(parentContext, parentState));
          _localctx = newContext;
          pushNewRecursionContext(newContext, startState, RuleExpr);
          setState(109);
        ...
        case 4: {
          auto newContext = _tracker.createInstance<EquealExpressoinContext>(_tracker.createInstance<ExprContext>(parentContext, parentState));
          _localctx = newContext;
          pushNewRecursionContext(newContext, startState, RuleExpr);
          setState(115);
...
TParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x3, 0x21, 0x9d, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4, 0x9, 
    ...
    0x9, 0x3, 0x9, 0x3, 0x9, 0x5, 0x9, 0x66, 0xa, 0x9, 0x3, 0x9, 0x3, 0x9, 
    ...
    0xb, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x7, 0xc, 0x89, 0xa, 0xc, 
    0xc, 0xc, 0xe, 0xc, 0x8c, 0xb, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 0xd, 0x3, 
    0xd, 0x3, 0xd, 0x3, 0xd, 0x7, 0xd, 0x94, 0xa, 0xd, 0xc, 0xd, 0xe, 0xd, 
    0x97, 0xb, 0xd, 0x3, 0xd, 0x3, 0xd, 0x3, 0xe, 0x3, 0xe, 0x3, 0xe, 0x3, 
    0x3e, 0x3, 0x10, 0xf, 0x2, 0x4, 0x6, 0x8, 0xa, 0xc, 0xe, 0x10, 0x12, 
    0x14, 0x16, 0x18, 0x1a, 0x2, 0x4, 0x3, 0x2, 0xd, 0xf, 0x3, 0x2, 0xe, 
    0xe, 0x2, 0xa4, 0x2, 0x1d, 0x3, 0x2, 0x2, 0x2, 0x4, 0x23, 0x3, 0x2, 
    0x2, 0x2, 0x6, 0x2b, 0x3, 0x2, 0x2, 0x2, 0x8, 0x41, 0x3, 0x2, 0x2, 0x2, 
    0xa, 0x43, 0x3, 0x2, 0x2, 0x2, 0xc, 0x48, 0x3, 0x2, 0x2, 0x2, 0xe, 0x59, 
    0x3, 0x2, 0x2, 0x2, 0x10, 0x65, 0x3, 0x2, 0x2, 0x2, 0x12, 0x80, 0x3, 
    0x2, 0x2, 0x2, 0x14, 0x82, 0x3, 0x2, 0x2, 0x2, 0x16, 0x84, 0x3, 0x2, 
    0x2, 0x2, 0x18, 0x8f, 0x3, 0x2, 0x2, 0x2, 0x1a, 0x9a, 0x3, 0x2, 0x2, 
    0x2, 0x1c, 0x1e, 0x5, 0xe, 0x8, 0x2, 0x1d, 0x1c, 0x3, 0x2, 0x2, 0x2, 
    0x1e, 0x1f, 0x3, 0x2, 0x2, 0x2, 0x1f, 0x1d, 0x3, 0x2, 0x2, 0x2, 0x1f, 
    0x20, 0x3, 0x2, 0x2, 0x2, 0x20, 0x21, 0x3, 0x2, 0x2, 0x2, 0x21, 0x22, 
