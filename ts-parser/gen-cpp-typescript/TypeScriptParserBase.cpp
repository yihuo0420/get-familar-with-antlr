...
bool TypeScriptParserBase::prev(std::string str) { return _input->LT(-1)->getText() == str; }

bool TypeScriptParserBase::n(std::string str) { return next(str); }

bool TypeScriptParserBase::next(std::string str) { return _input->LT(1)->getText() == str; }

bool TypeScriptParserBase::notLineTerminator() { return !here(TypeScriptParser::LineTerminator); }
...
bool TypeScriptParserBase::closeBrace() { return _input->LT(1)->getType() == TypeScriptParser::CloseBrace; }
