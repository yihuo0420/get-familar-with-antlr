...
namespace cyclone
{
  ...
  public:
    ...
    {
      RuleInitializer = 0,
      RuleBindingPattern = 1,
      RuleTypeParameters = 2,
      RuleTypeParameterList = 3,
      RuleTypeParameter = 4,
      RuleConstraint = 5,
      RuleTypeArguments = 6,
      RuleTypeArgumentList = 7,
      RuleTypeArgument = 8,
      RuleType_ = 9,
      RuleUnionOrIntersectionOrPrimaryType = 10,
      RulePrimaryType = 11,
      RulePredefinedType = 12,
      RuleTypeReference = 13,
      RuleNestedTypeGeneric = 14,
      RuleTypeGeneric = 15,
      RuleTypeIncludeGeneric = 16,
      RuleTypeName = 17,
      RuleObjectType = 18,
      RuleTypeBody = 19,
      RuleTypeMemberList = 20,
      RuleTypeMember = 21,
      RuleArrayType = 22,
      RuleTupleType = 23,
      RuleTupleElementTypes = 24,
      RuleFunctionType = 25,
      RuleConstructorType = 26,
      RuleTypeQuery = 27,
      RuleTypeQueryExpression = 28,
      RulePropertySignatur = 29,
      RuleTypeAnnotation = 30,
      RuleCallSignature = 31,
      RuleParameterList = 32,
      RuleRequiredParameterList = 33,
      RuleParameter = 34,
      RuleOptionalParameter = 35,
      RuleRestParameter = 36,
      RuleRequiredParameter = 37,
      RuleAccessibilityModifier = 38,
      RuleIdentifierOrPattern = 39,
      RuleConstructSignature = 40,
      RuleIndexSignature = 41,
      RuleMethodSignature = 42,
      RuleTypeAliasDeclaration = 43,
      RuleConstructorDeclaration = 44,
      RuleInterfaceDeclaration = 45,
      RuleInterfaceExtendsClause = 46,
      RuleClassOrInterfaceTypeList = 47,
      RuleEnumDeclaration = 48,
      RuleEnumBody = 49,
      RuleEnumMemberList = 50,
      RuleEnumMember = 51,
      RuleNamespaceDeclaration = 52,
      RuleNamespaceName = 53,
      RuleImportAliasDeclaration = 54,
      RuleDecoratorList = 55,
      RuleDecorator = 56,
      RuleDecoratorMemberExpression = 57,
      RuleDecoratorCallExpression = 58,
      RuleProgram = 59,
      RuleSourceElement = 60,
      RuleStatement = 61,
      RuleBlock = 62,
      RuleStatementList = 63,
      RuleAbstractDeclaration = 64,
      RuleImportStatement = 65,
      RuleFromBlock = 66,
      RuleMultipleImportStatement = 67,
      RuleExportStatement = 68,
      RuleVariableStatement = 69,
      RuleVariableDeclarationList = 70,
      RuleVariableDeclaration = 71,
      RuleEmptyStatement = 72,
      RuleExpressionStatement = 73,
      RuleIfStatement = 74,
      RuleIterationStatement = 75,
      RuleVarModifier = 76,
      RuleContinueStatement = 77,
      RuleBreakStatement = 78,
      RuleReturnStatement = 79,
      RuleYieldStatement = 80,
      RuleWithStatement = 81,
      RuleSwitchStatement = 82,
      RuleCaseBlock = 83,
      RuleCaseClauses = 84,
      RuleCaseClause = 85,
      RuleDefaultClause = 86,
      RuleLabelledStatement = 87,
      RuleThrowStatement = 88,
      RuleTryStatement = 89,
      RuleCatchProduction = 90,
      RuleFinallyProduction = 91,
      RuleDebuggerStatement = 92,
      RuleFunctionDeclaration = 93,
      RuleClassDeclaration = 94,
      RuleClassHeritage = 95,
      RuleClassTail = 96,
      RuleClassExtendsClause = 97,
      RuleImplementsClause = 98,
      RuleClassElement = 99,
      RulePropertyMemberDeclaration = 100,
      RulePropertyMemberBase = 101,
      RuleIndexMemberDeclaration = 102,
      RuleGeneratorMethod = 103,
      RuleGeneratorFunctionDeclaration = 104,
      RuleGeneratorBlock = 105,
      RuleGeneratorDefinition = 106,
      RuleIteratorBlock = 107,
      RuleIteratorDefinition = 108,
      RuleFormalParameterList = 109,
      RuleFormalParameterArg = 110,
      RuleLastFormalParameterArg = 111,
      RuleFunctionBody = 112,
      RuleSourceElements = 113,
      RuleArrayLiteral = 114,
      RuleElementList = 115,
      RuleArrayElement = 116,
      RuleObjectLiteral = 117,
      RulePropertyAssignment = 118,
      RuleGetAccessor = 119,
      RuleSetAccessor = 120,
      RulePropertyName = 121,
      RuleArguments = 122,
      RuleArgumentList = 123,
      RuleArgument = 124,
      RuleExpressionSequence = 125,
      RuleFunctionExpressionDeclaration = 126,
      RuleSingleExpression = 127,
      RuleAsExpression = 128,
      RuleArrowFunctionDeclaration = 129,
      RuleArrowFunctionParameters = 130,
      RuleArrowFunctionBody = 131,
      RuleAssignmentOperator = 132,
      RuleLiteral = 133,
      RuleTemplateStringLiteral = 134,
      RuleTemplateStringAtom = 135,
      RuleNumericLiteral = 136,
      RuleIdentifierName = 137,
      RuleIdentifierOrKeyWord = 138,
      RuleReservedWord = 139,
      RuleKeyword = 140,
      RuleGetter = 141,
      RuleSetter = 142,
      RuleEos = 143
    ...
    public:
      ...
      TypeScriptParser::SingleExpressionContext *object = nullptr;
